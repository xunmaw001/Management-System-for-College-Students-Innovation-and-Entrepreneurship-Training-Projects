...
public class ChuqidabianEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ChuqidabianEntity() {
		
	}
	
	public ChuqidabianEntity(T t) {
		try {
	 ...
	 * 设置：答辩文件
	 */
	public void setDabianwenjian(String dabianwenjian) {
		this.dabianwenjian = dabianwenjian;
	}
	/**
	 * 获取：答辩文件
	 */
	public String getDabianwenjian() {
		return dabianwenjian;
	}
	/**
	 * 设置：是否审核
	 */
