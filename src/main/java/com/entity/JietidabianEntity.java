...
public class JietidabianEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JietidabianEntity() {
		
	}
	
	public JietidabianEntity(T t) {
		try {
	 ...
	 * 设置：结题答辩
	 */
	public void setJietidabian(String jietidabian) {
		this.jietidabian = jietidabian;
	}
	/**
	 * 获取：结题答辩
	 */
	public String getJietidabian() {
		return jietidabian;
	}
	/**
	 * 设置：是否审核
