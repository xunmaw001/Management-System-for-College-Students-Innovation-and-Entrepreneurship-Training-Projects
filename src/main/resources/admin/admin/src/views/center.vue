<template>
  <div>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='jiaoshi'"  label="教师工号" prop="jiaoshigonghao">
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='xuesheng'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='zhuanjia'"  label="专家姓名" prop="zhuanjiaxingming">
          <el-input v-model="ruleForm.zhuanjiaxingming" readonly              placeholder="专家姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="flag=='zhuanjia'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='zhuanjia'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='zhuanjia'"  label="单位" prop="danwei">
          <el-input v-model="ruleForm.danwei"               placeholder="单位" clearable></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    onUpdateHandler() {
      ...
      if( 'zhuanjia' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
