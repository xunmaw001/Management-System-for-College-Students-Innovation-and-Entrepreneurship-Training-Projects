<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="项目名称" prop="xiangmumingcheng">
					<el-input v-model="ruleForm.xiangmumingcheng" placeholder="项目名称" clearable  :readonly="ro.xiangmumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="项目名称" prop="xiangmumingcheng">
					<el-input v-model="ruleForm.xiangmumingcheng" placeholder="项目名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="项目类别" prop="xiangmuleibie">
					<el-input v-model="ruleForm.xiangmuleibie" placeholder="项目类别" clearable  :readonly="ro.xiangmuleibie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="项目类别" prop="xiangmuleibie">
					<el-input v-model="ruleForm.xiangmuleibie" placeholder="项目类别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="经费来源" prop="jingfeilaiyuan">
					<el-input v-model="ruleForm.jingfeilaiyuan" placeholder="经费来源" clearable  :readonly="ro.jingfeilaiyuan"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="经费来源" prop="jingfeilaiyuan">
					<el-input v-model="ruleForm.jingfeilaiyuan" placeholder="经费来源" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="教师工号" prop="jiaoshigonghao">
					<el-input v-model="ruleForm.jiaoshigonghao" placeholder="教师工号" clearable  :readonly="ro.jiaoshigonghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="教师工号" prop="jiaoshigonghao">
					<el-input v-model="ruleForm.jiaoshigonghao" placeholder="教师工号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学生学号" prop="xueshengxuehao">
					<el-input v-model="ruleForm.xueshengxuehao" placeholder="学生学号" clearable  :readonly="ro.xueshengxuehao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="学生学号" prop="xueshengxuehao">
					<el-input v-model="ruleForm.xueshengxuehao" placeholder="学生学号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="学生姓名" prop="xueshengxingming">
					<el-input v-model="ruleForm.xueshengxingming" placeholder="学生姓名" clearable  :readonly="ro.xueshengxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="学生姓名" prop="xueshengxingming">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="提交时间" prop="tijiaoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tijiaoshijian" label="提交时间" prop="tijiaoshijian">
					<el-input v-model="ruleForm.tijiaoshijian" placeholder="提交时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="专家姓名" prop="zhuanjiaxingming">
					<el-input v-model="ruleForm.zhuanjiaxingming" placeholder="专家姓名" clearable  :readonly="ro.zhuanjiaxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="专家姓名" prop="zhuanjiaxingming">
					<el-input v-model="ruleForm.zhuanjiaxingming" placeholder="专家姓名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.zhongqidabian" label="中期答辩" prop="zhongqidabian">
					<file-upload
						tip="点击上传中期答辩"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.zhongqidabian?ruleForm.zhongqidabian:''"
						@change="zhongqidabianUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.zhongqidabian" label="中期答辩" prop="zhongqidabian">
					<el-button :style='{"border":"1px solid #aaa","cursor":"pointer","padding":"0 12px","margin":"0 20px 0 0","color":"#333","minWidth":"80px","outline":"none","borderRadius":"4px","background":"linear-gradient(200deg, rgba(216,223,236,1) 0%, rgba(247,249,251,1) 50%, rgba(210,217,230,1) 100%)","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' type="text" size="small" @click="download($base.url+ruleForm.zhongqidabian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.zhongqidabian" label="中期答辩" prop="zhongqidabian">
					<el-button :style='{"border":"1px solid #aaa","cursor":"pointer","padding":"0 12px","margin":"0 20px 0 0","color":"#333","minWidth":"80px","outline":"none","borderRadius":"4px","background":"linear-gradient(200deg, rgba(216,223,236,1) 0%, rgba(247,249,251,1) 50%, rgba(210,217,230,1) 100%)","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' type="text" size="small">无</el-button>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="小组成员" prop="xiaozuchengyuan">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="小组成员"
					  v-model="ruleForm.xiaozuchengyuan" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.xiaozuchengyuan" label="小组成员" prop="xiaozuchengyuan">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.xiaozuchengyuan}}</span>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				...
				xiangmuleibie : false,
				jingfeilaiyuan : false,
				jiaoshigonghao : false,
				xiaozuchengyuan : false,
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jingfeilaiyuan'){
							this.ruleForm.jingfeilaiyuan = obj[o];
							this.ro.jingfeilaiyuan = true;
							continue;
						}
						if(o=='jiaoshigonghao'){
						...
						if(o=='xiaozuchengyuan'){
							this.ruleForm.xiaozuchengyuan = obj[o];
							this.ro.xiaozuchengyuan = true;
							continue;
						}
						if(o=='xueshengxuehao'){
						...
						if(o=='zhongqidabian'){
							this.ruleForm.zhongqidabian = obj[o];
							this.ro.zhongqidabian = true;
							continue;
						}
				}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(json.xueshengxuehao!=''&&json.xueshengxuehao && this.$storage.get("role")!="管理员"){
	...
	if(this.ruleForm.zhongqidabian!=null) {
		this.ruleForm.zhongqidabian = this.ruleForm.zhongqidabian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhongqidabian/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhongqidabianCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    zhongqidabianUploadChange(fileUrls) {
	this.ruleForm.zhongqidabian = fileUrls;
    },
  }
};
</script>
