	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="项目评分" prop="xiangmupingfen">
					<el-input v-model="ruleForm.xiangmupingfen" placeholder="项目评分" clearable  :readonly="ro.xiangmupingfen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="项目评分" prop="xiangmupingfen">
					<el-input v-model="ruleForm.xiangmupingfen" placeholder="项目评分" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="评语" prop="pingyu">
					<el-input
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.pingyu" label="评语" prop="pingyu">
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xiangmupingfen'){
							this.ruleForm.xiangmupingfen = obj[o];
							this.ro.xiangmupingfen = true;
							continue;
						}
						if(o=='pingyu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jietipingjia/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jietipingjiaCrossAddOrUpdateFlag = false;
						 this.parent.search();
