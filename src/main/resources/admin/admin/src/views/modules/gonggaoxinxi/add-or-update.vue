	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="时间" prop="shijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shijian" label="时间" prop="shijian">
					<el-input v-model="ruleForm.shijian" placeholder="时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="来源" prop="laiyuan">
					<el-input v-model="ruleForm.laiyuan" placeholder="来源" clearable  :readonly="ro.laiyuan"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="来源" prop="laiyuan">
					<el-input v-model="ruleForm.laiyuan" placeholder="来源" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="内容" prop="neirong">
					<editor 
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.neirong" label="内容" prop="neirong">
...
export default {
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../springbootbaj1d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
